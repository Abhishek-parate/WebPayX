...
class OTPService:
    ...
    def send_login_otp(user_id: str, phone_number: str, user_name: str = "User", 
        ...
        try:
            ...
            existing_otps = db.session.query(OTPVerification).filter_by(
                user_id=user_id,
            ...
            if not otp_record.meta_data:
                otp_record.meta_data = {}
    ...
    def verify_otp(phone_number: str, otp_code: str, otp_type: OTPType, 
        ...
        try:
            # Find OTP record
            query = db.session.query(OTPVerification).filter_by(
                phone_number=phone_number,
                otp_type=otp_type,
                status=OTPStatus.PENDING
            )
