...
def create_app(config_name='development'):
    ...
    app.register_blueprint(enhanced_topup_bp)
...
def get_allowed_roles_for_creation(current_role):
    ...
    try:
        from routes.user_management import get_allowed_roles_for_creation
        return get_allowed_roles_for_creation(current_role)
    except Exception:
        return []
...
if __name__ == '__main__':
    ...
    print()
    print("💡 Note: Since you've already set up the database using fix_and_setup.py,")
    print("   the application will connect to your existing PostgreSQL database.")
